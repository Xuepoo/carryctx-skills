...
**Task Completion and Cleanup**: When you finish a task, complete it. v0.11.4 records eligible worktree removal as a durable cleanup request (since 0.8.0) and applies the configured policy; do not manually remove the worktree behind CarryCtx's back:
